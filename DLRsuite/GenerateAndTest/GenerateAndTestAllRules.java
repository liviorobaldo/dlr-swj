...
public class GenerateAndTestAllRules 
{
//----------------------------------------------------------------------------------------------------------------------------------------------- 
// This class generates and tests all possible applications of the rules in templateRulesUseCase0File.
// It uses a Boolean vector to assign true/false values to each rule. A rule is applied only if its corresponding value is true. 
// The inferred models are then checked to verify that all rules that should have been applied (expected model) were indeed applied.
// All possible Boolean assignments are generated and tested.
//-----------------------------------------------------------------------------------------------------------------------------------------------
    private static final File defaultUseCaseBaseline = new File("./D-KB/UseCaseBaseline.json");
    ...
    public static void main(String[] args)
    {
        try
        {
            File UseCaseBaseline = defaultUseCaseBaseline;
            if((args!=null)&&(args.length==1))UseCaseBaseline=new File(args[0]);
